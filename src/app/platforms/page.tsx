...
const synergyPoints = [
    { title: "Data Flow", description: "WorkID feeds SecondBank with work data, which creates value for SkillToken rewards, while Mezziah provides guidance and Libra ensures protection." },
    { title: "Value Creation", description: "Every action across platforms builds your reputation, increases earning potential, and unlocks new opportunities in the ecosystem." },
    { title: "Protection Layer", description: "Libra monitors all platforms for fair treatment, while Mezziah provides real-time guidance to navigate challenges and maximize benefits." },
    { title: "Growth Engine", description: "The more you engage with any platform, the more valuable you become across all platforms, creating a compounding effect on your career and income." }
]
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-background text-foreground">
      ...
      <main className="flex-1">
        ...
        <section id="pillars" className="w-full bg-primary/5 py-12 md:py-24 lg:py-32">
          <div className="container mx-auto px-4 md:px-6">
              ...
              {pillars.slice(0, 3).map((pillar) => (
                ...
                >
                  <CardHeader className="items-center text-center">
                    <div className={`mb-4 rounded-full border p-4 shadow-sm ${pillar.bgColor}`}>
                      <pillar.icon className={`h-8 w-8 ${pillar.color}`} />
                    </div>
                    <CardTitle className="font-headline text-2xl text-primary">
                      {pillar.name}
                    </CardTitle>
                    <p className="font-semibold text-muted-foreground">{pillar.title}</p>
                  </CardHeader>
        ...
        <section id="infrastructure" className="w-full py-12 md:py-24 lg:py-32">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center">
                    <h2 className="font-headline text-3xl font-bold tracking-tighter sm:text-4xl">🌍 Africa's First Workforce Infrastructure</h2>
                </div>
        ...
        <section id="synergy" className="w-full bg-primary/5 py-12 md:py-24 lg:py-32">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center">
                    <h2 className="font-headline text-3xl font-bold tracking-tighter sm:text-4xl">🔗 How They Work Together</h2>
                    <p className="mt-2 text-muted-foreground md:text-lg">Each platform strengthens the others, creating a comprehensive ecosystem.</p>
                </div>
                <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2">
                    {synergyPoints.map(point => (
                        <Card key={point.title} className="p-6">
                            <h3 className="font-headline text-xl font-bold text-primary">{point.title}</h3>
